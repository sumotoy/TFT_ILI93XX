#ifndef __TFT_ILI93XX_CPU_H
	#define __TFT_ILI93XX_CPU_H
	#include <stdint.h>
	...
	*/
		...
		#define _smCharType	uint8_t
			...
			static const uint32_t TFT_ILI93XX_SPI_SPEED 	= 80000000;
		#endif
		...
		#if defined(SPI_HAS_TRANSACTION)
			static const uint32_t TFT_ILI93XX_SPI_SPEED 	= 8000000;
		#endif
		#define _SPI_MULTITRANSFER	//enable burst multy byte transfer
		...
		#if defined(SPI_HAS_TRANSACTION)
			const uint32_t TFT_ILI93XX_SPI_SPEED 			= 24000000;
		#endif
		#define _SPI_MULTITRANSFER	//enable burst multy byte transfer
		...
		//#define _FORCE_PROGMEM__
		#define _smCharType	unsigned char
		static const uint32_t TFT_ILI93XX_SPI_SPEED 		= 30000000;
